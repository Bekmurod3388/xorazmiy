...
--}}
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150" style="background-image: url({{asset('texnikum_img/1.jpg')}})" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{asset('texnikum_img/2.png')}})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{asset('texnikum_img/33.png')}})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="category-text pt-40">
                            <h2>Texnikumning 2023-2024 o'quv yilidagi yo'nalishlari </h2>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-1">
                                        ...
                                        <span class="cont">
                                            <span>Kompyuter injiniring</span>
                                        </span>
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-2">
                                        ...
                                        <span class="cont">
                                            <span>Buxgalteriya hisobi va audit</span>
                                        </span>
                                    </span> <!-- singel category -->
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-3">
                                        ...
                                        <span class="cont">
                                            <span>Telekommunikatsiya texnologiyalari</span>
                                        </span>
                                    </span> <!-- singel category -->
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-1">
                                        ...
                                        <span class="cont">
                                            <span>Texnikumgacha ta'lim tashkiloti uslubchisi</span>
                                        </span>
                                    </span> <!-- singel category -->
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-2">
                                        ...
                                        <span class="cont">
                                            <span>Buxgalteriya hisob va audit <br><h6>Sirtqi</h6> </span>
                                        </span>
                                    </span> <!-- singel category -->
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-3">
                                        ...
                                        <span class="cont">
                                            <span>Elektr stansiyalari,tarmoqlari va tizimlari</span>
                                        </span>
                                    </span> <!-- singel category -->
                                </a>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title mt-50">
                        <h5>Biz haqimizda</h5>
                        <h2>Texnikum ramzlari</h2>
                    </div> <!-- section title -->
                    <div class="about-cont">
                        <p>
                            Urganch Davlat Universiteti huzuridagi Urganch tumani ko'p tarmoqli texnkumida barcha mutaxasisliklar bo'yicha bilim, ko'nikma va malakaga ega bo'ladilar
                            Texnikumning o'z yo'nalishlariga  mos ramzlari mavjud.
                        </p><br>
                        <h2>Texnikum shiori</h2> 
<p>Ilmdan bir shu’la dilga tushgan on, shundan bilursankim ilm bepoyon.</p>


                        <h2>Texnikum madhiyasi</h2>
                        <p>

                            Ulug' quch bilan yuksalar,<br> <br>
                            Texnikumim, bizga zamin.<br> <br>
                            Bilim-u san'at gullasa,<br> <br>
                            Senga doim bo'lar ta'zim. <br> <br>

                            Ko'p tarmoqli, aziz maskan,<br> <br>
                            O'qituvchi, talaba, hamjon.<br> <br>
                            Birgalikda orzu-umidlar,<br> <br>
                            Sening isming yuksalar har on.<br> <br>
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="about-event mt-50">
                        <div class="event-title">
                            <h3>Texnikum emblemasi</h3>
                        </div> <!-- event title -->
                        <img src="{{asset('texnikum_img/logo_texnikum.png')}}" alt="Emblema"><br>
                        <div class="event-title">
                            <h3>Texnikum nomi</h3>
                        </div> <!-- event title -->
                        <img src="{{asset('texnikum_img/000.jpg')}}" alt="Bayroq">
                    </div> <!-- about event -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-last order-lg-first">
                    <div class="video text-lg-left text-center pt-50">
                        <a class="Video-popup" href="https://www.youtube.com/watch?v=y-nYYXyZBuw"><i class="fa fa-play"></i></a>
                    </div> <!-- row -->
                </div>
                        ...
                        <ul>
                            <li>
                                <div class="singel-feature">
                                    ...
                                    <div class="cont">
                                        <h4> Davlat oliy ta'lim muassasalariga imtixonsiz  <br> 2- bosqich talabasi bo'lish</h4>
                                        <p> Texnikumni tamomlagan talabalar "2+2", "2+3" dasturi asosida davlat OTMlarida o'qishni davom ettirish imkoniyadini qo'lga kiritadilar </p>
                                        
                                        <button type="button" class="btn btn-warning"><a class="btn btn-denger" href="#">Batafsil</a></button>
                                    </div>
                                </div> <!-- singel feature -->
                            </li>
                            <li>
