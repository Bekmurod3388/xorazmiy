...
{{--                <img src="{{asset('assets/img/fonts/circle.jpg')}}" style="height: 100%" class="card-img" alt="...">--}}
                <p class="bg-dark pt-5 m-4 text-white text-center" style="opacity: 65%; height: 100%;width: 87%"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="90" fill="currentColor" class="bi bi-sort-alpha-up-alt" viewBox="0 0 16 16">
            ...
            <a class="card text-bg-dark mr-3" href="#" style="height: 300px;width: 33%">
