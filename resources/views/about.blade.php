            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="about-singel-items mt-30">
                        ...
                        <p>Mustaqil O'zbekistonimizga kuchli kadrlarni yetkazib berish</p></div> <!-- about singel -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="about-singel-items mt-30">
                        <span>03</span>
...
<div id="counter-part" class="bg_cover pt-65 pb-110" data-overlay="8" style="background-image: url({{asset('fasset/images/about1.jpg')}})">
    <div class="container">
        <div class="row">
