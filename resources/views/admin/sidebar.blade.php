            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item {{  request()->routeIs('admin.parent.index') ? 'active' : '' }}">
                    <a href="{{route('admin.parent.index')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" mr-3  bi bi-people-fill" viewBox="0 0 16 16">
                ...
                <li class="nav-item {{  request()->routeIs('admin.electroniclibrary.index') ? 'active' : '' }}">
