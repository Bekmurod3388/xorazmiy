    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-10"><h1 class="card-title">Faolni tahrirlash</h1></div>
                </div>
                <hr>
                <div class="card-body">
                    ...
                    <form action="{{route('admin.active.update',$posts)}}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
