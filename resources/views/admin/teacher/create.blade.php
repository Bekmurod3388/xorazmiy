    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-10"><h1 class="card-title">O'qituvchi qo'shish<h1></div>
                </div>
                <hr>
                <div class="card-body">
                    ...
                    <form action="{{route('admin.teacher.store')}}" method="POST" accept-charset="UTF-8"
                        ...
                        <div class="form-group">
                            <label>O'qituvchi haqida batafsil (UZ)</label>
